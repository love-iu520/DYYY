...
- (void)viewDidAppear:(BOOL)animated {
    %orig;
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(checkAndSkipLiveOrLowLikes) name:@"DYYYCheckNextAweme" object:nil];
}

- (void)checkAndSkipLiveOrLowLikes {
